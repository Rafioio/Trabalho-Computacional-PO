...
```bash
python src/scripts/map_viewer.py dados_generated.json    # abre dados_generated.json pontos e demandas
python src/scripts/map_viewer.py dados_generated.json --solution solucao.json  # abre a solução com as rotas
```
